---
id: rect-geo
title: 'Syntax & Other Concepts'
author: David Backer Peral, Josh Sugino
contributors: ___
description:
  'Explains the basics of formatting, syntax, and other basic functions of Java.'
---


<br />
Indentation
Indentation is used to visually structure your code, making it easier to read and understand. It's essential to follow a consistent indentation style throughout your codebase. One common indentation style is to use tabs for each level of indentation. 
<br />
You indent after … 
	1) Control statements: conditional statements, loops
	2) Classes & functions 
	<br />
Example: 
<LanguageSection>
...
Semicolons
DON’T forget semicolons. In Java, semicolons are used to terminate statements. 
You should use a semicolon at the end of each statement. 
For example:
